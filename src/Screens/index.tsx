//BOTTOM SCREENS
export {default as  Accueil} from './Bottom/Accueil'
export {default as  Collections} from './Bottom/Collections'
export {default as  Favoris} from './Bottom/Favoris'
export {default as  Recherche} from './Bottom/Recherche'

//AUTH SCREENS
export {default as  Welcome} from './AuthStack/Welcome'
...
// APPSTACK SCREENS
export {default as CollectionDetails} from './AppStack/CollectionDetails'
